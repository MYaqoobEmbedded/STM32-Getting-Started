...
#define I2C_TRANSMIT(addr, buf, len, time) (i2c_I2C1_masterTransmit(addr, buf, len, time))
#define I2C_RECEIVE(addr, buf, len, time) (i2c_I2C1_masterReceive(addr, buf, len, time))
