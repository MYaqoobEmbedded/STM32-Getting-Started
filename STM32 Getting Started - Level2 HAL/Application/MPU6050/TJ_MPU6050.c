...
#define I2C_TRANSMIT(addr, buf, len, time) (HAL_I2C_Master_Transmit(&hi2c1, addr, buf, len, time))
#define I2C_RECEIVE(addr, buf, len, time) (HAL_I2C_Master_Receive(&hi2c1, addr, buf, len, time))
